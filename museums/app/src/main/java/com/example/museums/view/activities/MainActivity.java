...
//        MuseumFacadeImpl i = new MuseumFacadeImpl(memsDao);
//        i.insertMuseum("1111", "tretizkovskayay", "Russia", "Moskow", "Novgorodskaya", "56");
//        //final TypeOfExihibit t1 = new TypeOfExihibit();
//        i.insertMuseum("2222", "tretizkovskayay", "Russia", "Moskow", "Novgorodskaya", "56");
//
