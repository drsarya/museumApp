...
//
//public class DetailedExhbtn extends Fragment implements IUpdateList, ILike, BasePresenter.View {
...
//        presenter = new GetLikesPresenter();
//        presenter.attach(this);
//        presenter.setInfo(userId, idExhibition, TypeOfArtEnum.EXHIBITION);
//    }
//
//    @Nullable
//    @Override
...
//
//        if (userId != -1) {
//            presenter.getUserLike();
//        }
//        presenter.getCountOfLikes();
//    }
//
//    @SuppressLint("ClickableViewAccessibility")
//    @RequiresApi(api = Build.VERSION_CODES.Q)
...
//
//            like.setOnClickListener(new ClickListenerChangeColorLike(presenter));
//        }
